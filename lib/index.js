...
const VirtualList = defineComponent({
  ...
  render() {
    ...
    const renderStickyHeaderSlot = () => {
      return stickyHeader ? h(ObserverItem, polyfillAttr({
    ...
    const renderStickyFooterSlot = () => {
      return stickyFooter ? h(ObserverItem, polyfillAttr({
    ...
    const renderHeaderSlot = () => {
      return header ? h(ObserverItem, polyfillAttr({
        key: "slot-header",
        class: headerClass,
        style: headerStyle
      }, {
    ...
    const renderFooterSlot = () => {
      return footer ? h(ObserverItem, polyfillAttr({
        key: "slot-footer",
        class: footerClass,
        style: footerStyle
      }, {
    ...
    const renderMainList = () => {
      ...
      for (let index = 0; index < filterList.length; index += 1) {
        ...
        }) : (_d = (_c = this.$slots) == null ? void 0 : _c.default) == null ? void 0 : _d.call(_c, {
          itemData: currentItem
        })])));
      }
