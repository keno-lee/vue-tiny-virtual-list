import { h } from "vue";
import { defineComponent, ref, onMounted, onBeforeUnmount, reactive, onBeforeMount, shallowRef, watch } from "vue-demi";
  ...
  render() {
    ...
    const renderMainList = () => {
      ...
      for (let index = 0; index < filterList.length; index += 1) {
        ...
        }, [(_b = (_a = this.$scopedSlots) == null ? void 0 : _a.default) == null ? void 0 : _b.call(_a, {
