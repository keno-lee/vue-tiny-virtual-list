...
function useVirtualList(userProps, emitFunction) {
  const props = new Proxy(userProps, {
    get(target, key) {
      var _a;
      return (_a = Reflect.get(target, key)) != null
        ? _a
        : Reflect.get(defaultProps, key);
    },
  });
  ...
  function getItemPosByIndex(index) {
    ...
    for (let i = 0; i <= index - 1; i += 1) {
      const currentSize = getItemSize(
        (_a = props.list[i]) == null ? void 0 : _a[itemKey],
      );
      topReduce += currentSize;
    }
    const current = getItemSize(
      (_b = props.list[index]) == null ? void 0 : _b[itemKey],
    );
    return {
      top: topReduce,
      current,
  ...
  async function scrollIntoView(index) {
    ...
    const currentSize = getItemSize(
      (_a = props.list[index]) == null ? void 0 : _a[props.itemKey],
    );
    if (
      targetMin < offsetMin &&
      offsetMin < targetMax &&
  ...
  async function scrollToTop() {
    ...
    setTimeout(() => {
      ...
      const directionKey = props.horizontal ? 'scrollLeft' : 'scrollTop';
      if (
        ((_a = clientRefEl == null ? void 0 : clientRefEl.value) == null
          ? void 0
          : _a[directionKey]) !== 0
      ) {
        scrollToTop();
  ...
  function calcRange() {
    ...
    if (direction === 'backward') {
      ...
      for (let i = start; i <= props.list.length - 1; i += 1) {
        const currentSize = getItemSize(
          (_b = props.list[i]) == null ? void 0 : _b[itemKey],
        );
        if (
          offsetReduce <= offsetWithNoHeader &&
          offsetWithNoHeader < offsetReduce + currentSize
  ...
  function onScroll(evt) {
    var _a, _b, _c;
    (_a = emitFunction == null ? void 0 : emitFunction.scroll) == null
      ? void 0
      : _a.call(emitFunction, evt);
    ...
    if (
      ...
      (_b = emitFunction == null ? void 0 : emitFunction.toTop) == null
        ? void 0
        : _b.call(emitFunction, props.list[0]);
    }
    if (
      direction === 'backward' &&
      ...
      (_c = emitFunction == null ? void 0 : emitFunction.toBottom) == null
        ? void 0
        : _c.call(emitFunction, props.list[props.list.length - 1]);
    }
  }
  function calcViews() {
      ...
      for (const entry of entries) {
        ...
        if (id) {
          ...
          if (id === 'client') {
            ...
            (_a = emitFunction == null ? void 0 : emitFunction.itemResize) ==
            null
              ? void 0
              : _a.call(emitFunction, id, newSize);
          }
        }
      }
  ...
  function getRangeSize(range1, range2) {
    ...
    for (let i = start; i < end; i += 1) {
      re += getItemSize(
        (_a = props.list[i]) == null ? void 0 : _a[props.itemKey],
      );
    }
    return re;
  }
        ...
        mainList.push(
          h(
            ...
            polyfillChildren([
              isVue2
                ? (_b =
                    (_a = this.$scopedSlots) == null ? void 0 : _a.default) ==
                  null
                  ? void 0
                  : _b.call(_a, {
...
export { ObserverItem, VirtualList, useObserverItem, useVirtualList };
